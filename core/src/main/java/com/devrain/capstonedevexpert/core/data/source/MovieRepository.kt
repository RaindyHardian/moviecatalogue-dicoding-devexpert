...
class MovieRepository(
    private val remoteDataSource: com.devrain.capstonedevexpert.core.data.source.remote.RemoteDataSource,
    private val localDataSource: com.devrain.capstonedevexpert.core.data.source.local.LocalDataSource,
...
//    }
    ...
    override fun getAllMovie(): Flow<com.devrain.capstonedevexpert.core.data.source.Resource<List<Movie>>> =
        object : com.devrain.capstonedevexpert.core.data.source.NetworkBoundResource<List<Movie>, List<MovieResponse>>() {
